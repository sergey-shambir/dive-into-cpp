...
TEST_CASE("Dot Function", "[Vector3f]")
{
	float d1 = dot(Vector3f{3, 6, 0}, Vector3f{1, 1, 1});
	REQUIRE(d1 == 9);
	
	float d2 = dot(Vector3f{5, 2, 1}, Vector3f{2, -3, 6});
	REQUIRE(d2 == 10);
	
	float d3 = dot(Vector3f{1, 2, 3}, Vector3f{4, -5, 6});
	REQUIRE(d3 == 12);
	
	float d4 = dot(Vector3f{1, 0, 1}, Vector3f{0, 0, 0});
	REQUIRE(d4 == 0);
}